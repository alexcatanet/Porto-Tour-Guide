...
public class CasaMusica extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        // Set the content of the activity to use the casa_da_musica.xml layout file
        setContentView(R.layout.casa_da_musica);
