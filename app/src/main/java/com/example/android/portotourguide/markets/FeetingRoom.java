...
public class FeetingRoom extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        // Set the content of the activity to use the feeting_room.xml layout file
        setContentView(R.layout.feeting_room);
