...
public class PedroLemos extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        // Set the content of the activity to use the pedro_lemos.xml layout file
        setContentView(R.layout.pedro_lemos);
